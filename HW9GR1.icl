...
depth :: (Tree Int) Int -> Int 
depth Leaf _ = 0
depth (Node x l r) n
| (level == n) && (x < 5) = x //+ depth l n (1+ level) + (depth r n (level + 1))
| otherwise = depth l n (1+ level) + (depth r n (level + 1))

Start = depth tree2 4 0
       
      
//umDepth :: (Tree Int) Int -> Int
