...
public class ImageProcessing {
    ...
    // The provided images are apple.jpg, flower.jpg, and kitten.jpg
		int[][] imageData = imgToTwoD("./watermel.jpg");
    ...
    // Or load your own image using a URL!
		...
		twoDToImage(trimmed, "./trimmed_watermel.jpg");
		

		int[][] negative = negativeColor(imageData);

		twoDToImage(negative, "./negative_watermel.jpg");
		

		int[][] stretchedHImg = stretchHorizontally(imageData);

		twoDToImage(stretchedHImg, "./stretched_watermel.jpg");
		

		int[][] shrankVImg = shrinkVertically(imageData);

		twoDToImage(shrankVImg, "./shrank_watermel.jpg");
		

		int[][] invertedImg = invertImage(imageData);

		twoDToImage(invertedImg, "./inverted_watermel.jpg");
		

		int[][] coloredImg = colorFilter(imageData, -75, 30, -30);

		twoDToImage(coloredImg, "./colored_waterwell.jpg");
